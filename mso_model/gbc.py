#!/usr/bin/env python
'''
Copyright (C) 2014  Marek Rudnicki
...
def calc_tf(q10, celsius, ref_temp=22):
    ''' Calculate the temperature compensation value
    ...
    q10: float
        The Q10 value
    celsius:
        Temperature to calculate the compaensation for [C]
    ref_temp:
        Reference temperature. Default = 22C
